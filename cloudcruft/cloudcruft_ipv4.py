...
class CloudcruftIpv4(Stack):
    ...
    ### CLOUDFRONT LOGS ###
        ...
        cloudcruftipv4cloudfrontlogs = _s3.Bucket(
            self, 'cloudcruftipv4cloudfrontlogs',
            bucket_name = 'cloudcruftipv4cloudfrontlogs',
        ...
        cloudcruftipv4cloudfrontlogs.add_lifecycle_rule(
    ...
    ### ACM CERTIFICATE ###
        ...
        acm = _acm.Certificate(
            self, 'acm',
            domain_name = 'ipv4.tundralabs.net',
    ...
    ### CLOUDFRONT ###
        ...
        distribution = _cloudfront.Distribution(
            ...
            certificate = acm,
            log_bucket = cloudcruftipv4cloudfrontlogs,
    ...
    ### DNS ENTRY ###
        ...
        cdnurl = _route53.ARecord(
            self, 'cdnurl',
            zone = hostzone,
            record_name = 'ipv4.tundralabs.net',
