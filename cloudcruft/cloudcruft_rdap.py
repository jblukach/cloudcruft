...
class CloudcruftRdap(Stack):
    ...
    ### LAYER ###
        ...
        whodap = _lambda.LayerVersion.from_layer_version_arn(
            self, 'whodap',
            layer_version_arn = 'arn:aws:lambda:'+region+':'+extensions.string_value+':layer:whodap:1'
        )
    ...
    ### LAMBDA ###
        ...
        compute = _lambda.Function(
            ...
            code = _lambda.Code.from_asset('api/rdap'),
    ...
    ### CLOUDFRONT LOGS ###
        ...
        cloudcruftrdapcloudfrontlogs = _s3.Bucket(
            self, 'cloudcruftrdapcloudfrontlogs',
            bucket_name = 'cloudcruftrdapcloudfrontlogs',
        ...
        cloudcruftrdapcloudfrontlogs.add_lifecycle_rule(
    ...
    ### ACM CERTIFICATE ###
        ...
        acm = _acm.Certificate(
            self, 'acm',
            domain_name = 'rdap.tundralabs.net',
    ...
    ### CLOUDFRONT ###
        ...
        distribution = _cloudfront.Distribution(
            ...
            certificate = acm,
            log_bucket = cloudcruftrdapcloudfrontlogs,
    ...
    ### DNS ENTRY ###
        ...
        cdnurl = _route53.ARecord(
            self, 'cdnurl',
            zone = hostzone,
            record_name = 'rdap.tundralabs.net',
