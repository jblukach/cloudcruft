...
class CloudcruftDns(Stack):
    ...
    ### CLOUDFRONT LOGS ###
        ...
        cloudcruftdnscloudfrontlogs = _s3.Bucket(
            self, 'cloudcruftdnscloudfrontlogs',
            bucket_name = 'cloudcruftdnscloudfrontlogs',
        ...
        cloudcruftdnscloudfrontlogs.add_lifecycle_rule(
    ...
    ### ACM CERTIFICATE ###
        ...
        acm = _acm.Certificate(
            self, 'acm',
            domain_name = 'dns.tundralabs.net',
    ...
    ### CLOUDFRONT ###
        ...
        distribution = _cloudfront.Distribution(
            ...
            certificate = acm,
            log_bucket = cloudcruftdnscloudfrontlogs,
    ...
    ### DNS ENTRY ###
        ...
        cdnurl = _route53.ARecord(
            self, 'cdnurl',
            zone = hostzone,
            record_name = 'dns.tundralabs.net',
