...
class CloudcruftEgress(Stack):
    ...
    ### LAMBDA ###
        ...
        compute = _lambda.Function(
            self, 'compute',
            function_name = 'egress',
            runtime = _lambda.Runtime.PYTHON_3_12,
            architecture = _lambda.Architecture.ARM_64,
            code = _lambda.Code.from_asset('api/egress'),
    ...
    ### CLOUDFRONT LOGS ###
        ...
        cloudcruftegresscloudfrontlogs = _s3.Bucket(
            self, 'cloudcruftegresscloudfrontlogs',
            bucket_name = 'cloudcruftegresscloudfrontlogs',
        ...
        cloudcruftegresscloudfrontlogs.add_lifecycle_rule(
    ...
    ### ACM CERTIFICATE ###
        ...
        acm = _acm.Certificate(
            self, 'acm',
            domain_name = 'egress.tundralabs.net',
    ...
    ### CLOUDFRONT ###
        ...
        distribution = _cloudfront.Distribution(
            ...
            certificate = acm,
            log_bucket = cloudcruftegresscloudfrontlogs,
    ...
    ### DNS ENTRY ###
        ...
        cdnurl = _route53.ARecord(
            self, 'cdnurl',
            zone = hostzone,
            record_name = 'egress.tundralabs.net',
