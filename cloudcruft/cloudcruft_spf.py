...
class CloudcruftSpf(Stack):
    ...
    ### CLOUDFRONT LOGS ###
        ...
        cloudcruftspfcloudfrontlogs = _s3.Bucket(
            self, 'cloudcruftspfcloudfrontlogs',
            bucket_name = 'cloudcruftspfcloudfrontlogs',
        ...
        cloudcruftspfcloudfrontlogs.add_lifecycle_rule(
    ...
    ### CLOUDFRONT ###
        ...
        distribution = _cloudfront.Distribution(
            ...
            certificate = acm,
            log_bucket = cloudcruftspfcloudfrontlogs,
