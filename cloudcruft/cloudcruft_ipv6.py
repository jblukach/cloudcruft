...
class CloudcruftIpv6(Stack):
    ...
    ### CLOUDFRONT LOGS ###
        ...
        cloudcruftipv6cloudfrontlogs = _s3.Bucket(
            self, 'cloudcruftipv6cloudfrontlogs',
            bucket_name = 'cloudcruftipv6cloudfrontlogs',
        ...
        cloudcruftipv6cloudfrontlogs.add_lifecycle_rule(
    ...
    ### ACM CERTIFICATE ###
        ...
        acm = _acm.Certificate(
            self, 'acm',
            domain_name = 'ipv6.tundralabs.net',
    ...
    ### CLOUDFRONT ###
        ...
        distribution = _cloudfront.Distribution(
            ...
            certificate = acm,
            log_bucket = cloudcruftipv6cloudfrontlogs,
    ...
    ### DNS ENTRY ###
        ...
        cdnurl = _route53.ARecord(
            self, 'cdnurl',
            zone = hostzone,
            record_name = 'ipv6.tundralabs.net',
